...
from .views import edit_account, edit_user_password, IndexClass, LoginClass, logout, login
...
urlpatterns = [
    ...
    url(r'^edit_user_password/', edit_user_password, name='edit_user_password'),
